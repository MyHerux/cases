...
import com.heroxu.cases.kafka.proto.GrinDeserializer;
import com.heroxu.cases.kafka.proto.GrinSerializer;
...
public class KafkaConfig {
    ...
    private Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, GrinDeserializer.class);
    ...
    private Map<String,Object> producerConfigs(){
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, GrinSerializer.class);
